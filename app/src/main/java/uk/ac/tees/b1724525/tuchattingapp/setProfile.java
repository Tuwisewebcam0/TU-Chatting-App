...
public class setProfile extends AppCompatActivity {
    ...
    ProgressBar mprogrossbarofsetprofile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        storageReference = firebaseStorage.getReference(); //storageReference helps to save images in database
        ...
        mprogrossbarofsetprofile = findViewById(R.id.progressbarofsetProfile);
        ...
        msaveprofile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                } else if (imagepath == null) // it means user did not select image//

                {
                    Toast.makeText(getApplicationContext(), "Image is Empty", Toast.LENGTH_SHORT).show();
                } else {

                    mprogrossbarofsetprofile.setVisibility(View.VISIBLE);
                    sendDataForNewUser();
                    mprogrossbarofsetprofile.setVisibility(View.INVISIBLE);
    ...
    private void sendDataTocloudFirestore() { // sending data to cloud firestore//


        DocumentReference documentReference=firebaseFirestore.collection("Users").document(firebaseAuth.getUid());
        Map<String , Object> userdata=new HashMap<>();
        userdata.put("name",name);                  //key and value//
