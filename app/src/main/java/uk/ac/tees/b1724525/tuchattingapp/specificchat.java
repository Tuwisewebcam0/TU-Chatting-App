...
public class specificchat extends AppCompatActivity {
    ...
    String sendername;
    String mreceiveruid;
    String msenderuid;        //holds the receiver name whom message is sent to//
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        msendmessagebutton.setOnClickListener(view -> {
...

            {
                ...
                Messages messages=new Messages(enteredmessage,firebaseAuth.getUid(),date.getTime(),sendername, currenttime);
                firebaseDatabase=FirebaseDatabase.getInstance();
